...
(begin 2 (define x (+ x 1)))
; expect x

x
; expect 1

(define (outer-func x) (define (inner z y) (+ x (* z 3) y)) inner)
; expect outer-func

(define (f x y) (define (f1 z) (+ x y z)) f1)
; expect f
...
(define k (lambda () (define a 1) (define z 5) (g)))
; expect k
